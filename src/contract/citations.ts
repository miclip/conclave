...
export const CITED: Record<string, string> = {
  ...
  'src/relay/relay.ts:3488': 'if (this.#worktreesAtStart) for (const w of worktreePaths',
  'src/relay/relay.ts:3972': 'resolutionFor(p.subject, { rotationArmed: armed })',
  'src/relay/relay.ts:4577': 'No rotation checks are configured',
  ...
  'src/relay/relay.ts:5852': 'this.#worktreesAtStart = worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:6586': "subject: { reason: 'turn_incomplete', participant: lead.id }",
  ...
  'src/relay/relay.ts:6590': 'verdictOf: { participant: lead.id, endSeq: current.seq },',
  'src/relay/relay.ts:6707': 'The human has seen your escalation and asked you to continue.',
  ...
  'src/relay/relay.ts:6870': "reason: 'authority_conflict', workstream:",
  'src/relay/relay.ts:6969': "subject: { reason: 'implementer_unanswered', participant: seat.id }",
  'src/relay/relay.ts:7020': "its report could not be read, so there is",
  ...
  'src/relay/relay.ts:7031': "knowing whether the child is still writing changes what the operator does.",
  'src/relay/relay.ts:7102': "subject: { reason: 'turn_incomplete', participant: seat.id }",
  'src/relay/relay.ts:7106': 'verdictOf: { participant: seat.id, endSeq: current.seq },',
  ...
  'src/relay/relay.ts:4396': 'async #considerRotation(',
  'src/relay/relay.ts:4619-4623':
  ...
  'src/relay/relay.ts:4664-4668':
    ...
    "        ? this.#answeredByReplacement(impl, snap.compactionGeneration)\n" +
    "        : this.#acknowledge(impl, snap.compactionGeneration)",
  'src/relay/relay.ts:4690': 'return this.#acknowledge(impl, snap.compactionGeneration)',
  'src/relay/relay.ts:4721-4731':
    "        detail:\n" +
