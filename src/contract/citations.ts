...
export const CITED: Record<string, string> = {
  ...
  'bin/conclave.ts:1711-1713': "    const relay = await Relay.start({\n      registry,\n      cwd: process.cwd(),",
  'bin/conclave.ts:1803': 'runReport(relay, { goal, outcome, startedAt: runStartedAt, build })',
  ...
  'bin/conclave.ts:1497-1500': "...extraArgs(flag('implementer-args', ''))",
