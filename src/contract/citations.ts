...
export const CITED: Record<string, string> = {
  ...
  'bin/conclave.ts:1854-1856': "    const relay = await Relay.start({\n      registry,\n      cwd: process.cwd(),",
  'bin/conclave.ts:1953': 'runReport(relay, { goal, outcome, startedAt: runStartedAt, build })',
  ...
  'bin/conclave.ts:1640-1643': "...extraArgs(flag('implementer-args', ''))",
