...
export const CITED: Record<string, string> = {
  ...
  'bin/conclave.ts:1281': '{ ...s.status, alive: s.alive, abandoned: s.abandoned }',
  'bin/conclave.ts:2219-2221': "    const relay = await Relay.start({\n      registry,\n      cwd: process.cwd(),",
  'bin/conclave.ts:2321': 'runReport(relay, { goal, outcome, startedAt: runStartedAt, build })',
  ...
  'bin/conclave.ts:2003-2006': "...extraArgs(flag('implementer-args', ''))",
