...
export const CITED: Record<string, string> = {
  ...
  'src/relay/relay.ts:4662': 'resolutionFor(p.subject, { rotationArmed: armed })',
  'src/relay/relay.ts:5267': 'No rotation checks are configured',
  ...
  'src/relay/relay.ts:6744': 'this.#worktreesAtStart = worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:7611': "subject: { reason: 'turn_incomplete', participant: lead.id }",
  ...
  'src/relay/relay.ts:7615': 'verdictOf: { participant: lead.id, endSeq: current.seq },',
  'src/relay/relay.ts:7750': 'The human has seen your escalation and asked you to continue.',
  ...
  'src/relay/relay.ts:7917': "reason: 'authority_conflict', workstream:",
  'src/relay/relay.ts:8032': "subject: { reason: 'implementer_unanswered', participant: seat.id }",
  'src/relay/relay.ts:8083': "its report could not be read, so there is",
  ...
  'src/relay/relay.ts:8094': "knowing whether the child is still writing changes what the operator does.",
  'src/relay/relay.ts:8165': "subject: { reason: 'turn_incomplete', participant: seat.id }",
  'src/relay/relay.ts:8169': 'verdictOf: { participant: seat.id, endSeq: current.seq },',
  ...
  'src/relay/relay.ts:5086': 'async #considerRotation(',
  'src/relay/relay.ts:5309-5313':
  ...
  'src/relay/relay.ts:5354-5358':
    ...
    "        ? this.#answeredByReplacement(impl, snap.compactionGeneration)\n" +
    "        : this.#acknowledge(impl, snap.compactionGeneration)",
  'src/relay/relay.ts:5380': 'return this.#acknowledge(impl, snap.compactionGeneration)',
  'src/relay/relay.ts:5411-5421':
    "        detail:\n" +
