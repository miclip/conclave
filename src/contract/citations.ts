...
export const CITED: Record<string, string> = {
  ...
  'bin/conclave.ts:1422': '{ ...s.status, alive: s.alive, abandoned: s.abandoned }',
  'bin/conclave.ts:2421-2423': "    const relay = await Relay.start({\n      registry,\n      cwd: process.cwd(),",
  'bin/conclave.ts:2523': 'runReport(relay, { goal, outcome, startedAt: runStartedAt, build })',
  ...
  'bin/conclave.ts:2195-2198': "...extraArgs(flag('implementer-args', ''))",
