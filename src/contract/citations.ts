...
export const CITED: Record<string, string> = {
  ...
  'bin/conclave.ts:1814-1816': "    const relay = await Relay.start({\n      registry,\n      cwd: process.cwd(),",
  'bin/conclave.ts:1906': 'runReport(relay, { goal, outcome, startedAt: runStartedAt, build })',
  ...
  'bin/conclave.ts:1600-1603': "...extraArgs(flag('implementer-args', ''))",
