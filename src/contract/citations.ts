...
export const CITED: Record<string, string> = {
  ...
  'bin/conclave.ts:2255-2257': "    const relay = await Relay.start({\n      registry,\n      cwd: process.cwd(),",
  'bin/conclave.ts:2357': 'runReport(relay, { goal, outcome, startedAt: runStartedAt, build })',
  ...
  'bin/conclave.ts:2040-2043': "...extraArgs(flag('implementer-args', ''))",
