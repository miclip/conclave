...
export const CITED: Record<string, string> = {
  ...
  'bin/conclave.ts:1374': '{ ...s.status, alive: s.alive, abandoned: s.abandoned }',
  'bin/conclave.ts:2348-2350': "    const relay = await Relay.start({\n      registry,\n      cwd: process.cwd(),",
  'bin/conclave.ts:2450': 'runReport(relay, { goal, outcome, startedAt: runStartedAt, build })',
  ...
  'bin/conclave.ts:2133-2136': "...extraArgs(flag('implementer-args', ''))",
