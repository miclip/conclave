...
export const CITED: Record<string, string> = {
  ...
  'src/relay/relay.ts:3028-3029': "this.#worktreesSeen.add(w)\n    return {",
  'src/relay/relay.ts:3129': 'NOT ARMED (no checks configured)',
  'src/relay/relay.ts:3626': 'if (this.#worktreesAtStart) for (const w of worktreePaths',
  'src/relay/relay.ts:4110': 'resolutionFor(p.subject, { rotationArmed: armed })',
  'src/relay/relay.ts:4715': 'No rotation checks are configured',
  ...
  'src/relay/relay.ts:5990': 'this.#worktreesAtStart = worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:6770': "subject: { reason: 'turn_incomplete', participant: lead.id }",
  ...
  'src/relay/relay.ts:6774': 'verdictOf: { participant: lead.id, endSeq: current.seq },',
  'src/relay/relay.ts:6891': 'The human has seen your escalation and asked you to continue.',
  ...
  'src/relay/relay.ts:7058': "reason: 'authority_conflict', workstream:",
  'src/relay/relay.ts:7157': "subject: { reason: 'implementer_unanswered', participant: seat.id }",
  'src/relay/relay.ts:7208': "its report could not be read, so there is",
  ...
  'src/relay/relay.ts:7219': "knowing whether the child is still writing changes what the operator does.",
  'src/relay/relay.ts:7290': "subject: { reason: 'turn_incomplete', participant: seat.id }",
  'src/relay/relay.ts:7294': 'verdictOf: { participant: seat.id, endSeq: current.seq },',
  ...
  'src/relay/relay.ts:4534': 'async #considerRotation(',
  'src/relay/relay.ts:4757-4761':
  ...
  'src/relay/relay.ts:4802-4806':
    ...
    "        ? this.#answeredByReplacement(impl, snap.compactionGeneration)\n" +
    "        : this.#acknowledge(impl, snap.compactionGeneration)",
  'src/relay/relay.ts:4828': 'return this.#acknowledge(impl, snap.compactionGeneration)',
  'src/relay/relay.ts:4859-4869':
    "        detail:\n" +
