...
const CITED: Record<string, string> = {
  ...
  'src/relay/relay.ts:2206': 'worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:2608': 'resolutionFor(p.subject, { rotationArmed: armed })',
  'src/relay/relay.ts:2786-2792': 'No rotation checks are configured',
  'src/relay/relay.ts:310': "onDegradation ?? 'candidate'",
  'src/relay/relay.ts:3638': 'worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:4105': "subject: { reason: 'turn_incomplete', participant: lead.id }",
  'src/relay/relay.ts:4355': "subject: { reason: 'implementer_unanswered', participant: seat.id }",
  'src/relay/relay.ts:4488': "subject: { reason: 'turn_incomplete', participant: seat.id }",
