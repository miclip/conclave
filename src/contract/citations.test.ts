...
const CITED: Record<string, string> = {
  ...
  'src/relay/relay.ts:1336-1338': 'get cwd(): string',
  'src/relay/relay.ts:1457-1463': 'createParticipant(spec, ctx)',
  'src/relay/relay.ts:2004': 'worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:2031': 'NOT ARMED (no checks configured)',
  'src/relay/relay.ts:2101': 'worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:2503': 'resolutionFor(p.subject, { rotationArmed: armed })',
  'src/relay/relay.ts:2681-2688': 'No rotation checks are configured',
  'src/relay/relay.ts:309': "onDegradation ?? 'candidate'",
  'src/relay/relay.ts:3452': 'worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:3792': "subject: { reason: 'turn_incomplete', participant: lead.id }",
  'src/relay/relay.ts:4042': "subject: { reason: 'implementer_unanswered', participant: seat.id }",
  'src/relay/relay.ts:4175': "subject: { reason: 'turn_incomplete', participant: seat.id }",
