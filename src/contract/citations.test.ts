...
const CITED: Record<string, string> = {
  ...
  'src/relay/relay.ts:2727': 'resolutionFor(p.subject, { rotationArmed: armed })',
  'src/relay/relay.ts:2905-2911': 'No rotation checks are configured',
  'src/relay/relay.ts:312': "onDegradation ?? 'candidate'",
  'src/relay/relay.ts:3757': 'worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:4224': "subject: { reason: 'turn_incomplete', participant: lead.id }",
  ...
  'src/relay/relay.ts:4227': 'verdictOf: { participant: lead.id, endSeq: next.end.seq },',
  'src/relay/relay.ts:4326': 'The human has seen your escalation and asked you to continue.',
  ...
  'src/relay/relay.ts:4390': "reason: 'authority_conflict', workstream:",
  'src/relay/relay.ts:4474': "subject: { reason: 'implementer_unanswered', participant: seat.id }",
  'src/relay/relay.ts:4523': "subject: { reason: 'advisor_escalated' },",
  'src/relay/relay.ts:4536': '#livenessEvidence(seat, report.emittedSinceSend)',
  'src/relay/relay.ts:4607': "subject: { reason: 'turn_incomplete', participant: seat.id }",
  'src/relay/relay.ts:4613': 'verdictOf: { participant: seat.id, endSeq: current.seq },',
