...
const CITED: Record<string, string> = {
  ...
  'src/relay/relay.ts:1520-1522': 'get cwd(): string',
  'src/relay/relay.ts:1670-1676': 'createParticipant(spec, ctx)',
  'src/relay/relay.ts:2217': 'worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:2244': 'NOT ARMED (no checks configured)',
  'src/relay/relay.ts:2314': 'worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:2716': 'resolutionFor(p.subject, { rotationArmed: armed })',
  'src/relay/relay.ts:2894-2900': 'No rotation checks are configured',
  'src/relay/relay.ts:312': "onDegradation ?? 'candidate'",
  'src/relay/relay.ts:3746': 'worktreePaths(this.#opts.cwd)',
  'src/relay/relay.ts:4213': "subject: { reason: 'turn_incomplete', participant: lead.id }",
  ...
  'src/relay/relay.ts:4216': 'verdictOf: { participant: lead.id, endSeq: next.end.seq },',
  'src/relay/relay.ts:4315': 'The human has seen your escalation and asked you to continue.',
  ...
  'src/relay/relay.ts:4379': "reason: 'authority_conflict', workstream:",
  'src/relay/relay.ts:4463': "subject: { reason: 'implementer_unanswered', participant: seat.id }",
  'src/relay/relay.ts:4512': "subject: { reason: 'advisor_escalated' },",
  'src/relay/relay.ts:4525': '#livenessEvidence(seat, report.emittedSinceSend)',
  'src/relay/relay.ts:4596': "subject: { reason: 'turn_incomplete', participant: seat.id }",
  'src/relay/relay.ts:4602': 'verdictOf: { participant: seat.id, endSeq: current.seq },',
