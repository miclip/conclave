 ...
 * seat (bin/conclave.ts:1026-1029), and project config carries no per-agent launch args at all
 ...
 * still the production ones: `runReport` is what `bin/conclave.ts:1259` prints, and the status
