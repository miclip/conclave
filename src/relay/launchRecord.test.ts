 ...
 * seat (bin/conclave.ts:1011-1014), and project config carries no per-agent launch args at all
 ...
 * still the production ones: `runReport` is what `bin/conclave.ts:1232` prints, and the status
