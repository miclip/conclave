...
does not go stale when you upgrade. A registration written before v0.5.39 does name one;
...
```sh
curl -fsSL https://raw.githubusercontent.com/miclip/conclave/v0.5.39/scripts/install.sh | sh
```
