...
registration stands aside for that seat so no event is delivered twice. A registration written before v0.5.61 does name one;
...
```sh
curl -fsSL https://raw.githubusercontent.com/miclip/conclave/v0.5.61/scripts/install.sh | sh
```
