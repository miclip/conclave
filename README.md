...
does not go stale when you upgrade. A registration written before v0.5.48 does name one;
...
```sh
curl -fsSL https://raw.githubusercontent.com/miclip/conclave/v0.5.48/scripts/install.sh | sh
```
