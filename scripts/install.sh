...
#
#   curl -fsSL https://raw.githubusercontent.com/miclip/conclave/v0.5.31/scripts/install.sh | sh
#
...
#   ~/.local/bin/conclave -> ~/.local/share/conclave-releases/v0.5.31/bin/conclave
#
